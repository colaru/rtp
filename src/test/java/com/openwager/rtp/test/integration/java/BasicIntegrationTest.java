...
public class BasicIntegrationTest extends TestVerticle {
        ...
        container.deployVerticle(EventBusVerticle.class.getName(), new AsyncResultHandler<String>() {
            ...
            public void handle(AsyncResult<String> asyncResult) {
                ...
                if (asyncResult.failed()) {
                    ...
                    vertx.eventBus().send("default.address", Util.createEventMessage(), new Handler<Message<String>>() {
                        @Override
    ...
    public void testEventBusPublishSubscribe() {
        ...
        vertx.eventBus().publish("default.address", Util.createEventMessage());

        vertx.eventBus().registerHandler("default.address", new Handler<Message<String>>() {
            @Override
            public void handle(Message<String> reply) {
                assertEquals(Util.createEventMessage(), reply.body());
